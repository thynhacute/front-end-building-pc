          ...
          <div className="latest_product_inner">
            <div className="row">
              <div className="col-lg-4 col-md-6">
                <div className="single-product">
                  <div className="product-img">
                    <img className="card-img" src="img/product/inspired-product/i1.jpg" alt />
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-product">
                  <div className="product-img">
                    <img className="card-img" src="img/product/inspired-product/i2.jpg" alt />
                    <div className="p_icon">
                      <a href="#">
                        <i className="ti-eye" />
                      </a>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-product">
                  <div className="product-img">
                    <img className="card-img" src="img/product/inspired-product/i3.jpg" alt />
                    <div className="p_icon">
                      <a href="#">
                        <i className="ti-eye" />
                      </a>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-product">
                  <div className="product-img">
                    <img className="card-img" src="img/product/inspired-product/i4.jpg" alt />
                    <div className="p_icon">
                      <a href="#">
                        <i className="ti-eye" />
                      </a>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-product">
                  <div className="product-img">
                    <img className="card-img" src="img/product/inspired-product/i5.jpg" alt />
                    <div className="p_icon">
                      <a href="#">
                        <i className="ti-eye" />
                      </a>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-product">
                  <div className="product-img">
                    <img className="card-img" src="img/product/inspired-product/i6.jpg" alt />
                    <div className="p_icon">
                      <a href="#">
                        <i className="ti-eye" />
                      </a>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-product">
                  <div className="product-img">
                    <img className="card-img" src="img/product/inspired-product/i7.jpg" alt />
                    <div className="p_icon">
                      <a href="#">
                        <i className="ti-eye" />
                      </a>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-product">
                  <div className="product-img">
                    <img className="card-img" src="img/product/inspired-product/i8.jpg" alt />
                    <div className="p_icon">
                      <a href="#">
                        <i className="ti-eye" />
                      </a>
